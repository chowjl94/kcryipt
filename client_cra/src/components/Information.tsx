...
const InfoCard = ({ stepnum, stepinstruction }: ParamProps) => (
  <div className="flex flex-col justify-start items-center p-3 m-2">
    <div
      className={`w-10 h-10 rounded-full flex flex-col justify-center items-center white-glassmorphism text-white`}
    >
      {stepnum}
    </div>
    <div className="flex flex-col flex-1 items-center text-ellipsis">
      <h3 className="mt-2 h-9 text-center text-ellipsis text-white lg md:w-9/12">
        {stepinstruction}
      </h3>
    </div>
  </div>
      ...
      <div className="flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col px-5 md:mr-10">
          ...
          <div className="flex flex-row px-3 py-3 gap-3 items-center">
            ...
            <InfoCard
              stepnum="2"
              stepinstruction="Input wallet address and amount"
            />
            <div
              className={`w-10 h-10 rounded-full flex flex-col justify-center items-center white-glassmorphism text-white`}
            >
            ...
            <InfoCard
              stepnum="4"
              stepinstruction="View your past transactions"
            />
          </div>
        </div>
      </div>
